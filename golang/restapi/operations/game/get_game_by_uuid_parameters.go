...
// NewGetGameByUUIDParams creates a new GetGameByUUIDParams object
// with the default values initialized.
func NewGetGameByUUIDParams() GetGameByUUIDParams {
	var ()
	return GetGameByUUIDParams{}
}

// GetGameByUUIDParams contains all the bound params for the get game by UUID operation
...
func (o *GetGameByUUIDParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
