...
// NewPutGameByUUIDParams creates a new PutGameByUUIDParams object
// with the default values initialized.
func NewPutGameByUUIDParams() PutGameByUUIDParams {
	var ()
	return PutGameByUUIDParams{}
}

// PutGameByUUIDParams contains all the bound params for the put game by UUID operation
...
func (o *PutGameByUUIDParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
