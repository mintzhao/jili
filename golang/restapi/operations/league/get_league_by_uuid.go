...
func (fn GetLeagueByUUIDHandlerFunc) Handle(params GetLeagueByUUIDParams) middleware.Responder {
	return fn(params)
}
...
func NewGetLeagueByUUID(ctx *middleware.Context, handler GetLeagueByUUIDHandler) *GetLeagueByUUID {
	return &GetLeagueByUUID{Context: ctx, Handler: handler}
}
...
func (o *GetLeagueByUUID) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewGetLeagueByUUIDParams()
